...
+
image::devperspective.png[devperspective,300, link=self,window=blank]

. Then switch to the Topology View:
+
image::topology.png[topology,300, link=self,window=blank]

. Select your project (`{user}-quarkus`):
+
image::projlist.png[project,700, link=self,window=blank]
