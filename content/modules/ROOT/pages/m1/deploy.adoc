...
Using project "devspaces-{user}-qyf6iq".
...
For this scenario, a project has been created for you called `{user}-project`. You will use this project to deploy your developed project in the next step.
...
quarkus.container-image.group=%ENTER_USERID_AT_TOP_OF_PAGE%-project<10>
...
Select your project (`{user}-project`):
