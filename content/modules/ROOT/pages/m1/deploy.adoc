...
Using project "devspaces-{USER_ID}-qyf6iq".
...
Now that your app is deployed to OpenShift you can also see it in the https://console-openshift-console.{ROUTE_SUBDOMAIN}[OpenShift Console^]. Login with `{USER_ID}/{USER_PASSWORD}`
