...
Using project "user-{user}-devspaces"

Using project "devspaces-{user}".
----
...
+
You can also access the URL by clicking on this link: https://people-{user}-quarkus.apps.{openshift_cluster_ingress_domain}/hello[hello endpoint^]
+
