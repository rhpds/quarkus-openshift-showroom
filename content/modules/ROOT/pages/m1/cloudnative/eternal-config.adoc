...
image::quickfix.png[quickfix, 600, link=self,window=blank]

and select `Import 'ConfigProperty' (org.eclipse.microprofile.config.inject)`.

image::quickfiximport.png[quickfix, 600, link=self,window=blank]
...
image::quarkus-devui-configeditor.png[quarkus-devui-configeditor, 700, link=self,window=blank]
...
image::quarkus-devui-configeditor-update2.png[quarkus-devui-configeditor, 700, link=self,window=blank]
