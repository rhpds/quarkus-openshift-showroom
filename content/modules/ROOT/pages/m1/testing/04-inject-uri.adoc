...
. Let's write a simple test that shows this off to load some static resources. 
. Create a new file names `test.html` file in *src/main/resources/META-INF/resources/*. 

. Paste the following HTML code to the file:
+
