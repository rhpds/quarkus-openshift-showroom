...
image::crwdebug.png[buttons, 600, link=self,window=blank]
...
image::buttons.png[buttons, 600, link=self,window=blank]

Click on `Yes` to enable the *Debug* mode:

image::debug-mode.png[debug-mode, 600, link=self,window=blank]
...
image::break.png[breakpoint,800, link=self,window=blank]
...
image::breakreached.png[breakpointreached, link=self,window=blank]
...
image::stepover.png[length, 800, link=self,window=blank]
...
image::len.png[length, 800, link=self,window=blank]
...
image::debug-continue.png[buttons, 600, link=self,window=blank]
...
image::fixed.png[length, 800, link=self,window=blank]
...
image::debug-disconnect.png[buttons, 600, link=self,window=blank]
