...
From the https://console-openshift-console.{openshift_cluster_ingress_domain}/topology/ns/{user}-quarkus[Topology View^], click on **Installed Operators** in the sidebar menu and select **Tempo**

image::operators-list.png[operators,800]

Select **Create TempoMonolithic**:
