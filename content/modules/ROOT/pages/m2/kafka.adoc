...
Back on the https://console-openshift-console.{ROUTE_SUBDOMAIN}/topology/ns/{USER_ID}-project?view=graph[Topology View^], make sure all the Kafka pods are up and running (with dark blue circles):
