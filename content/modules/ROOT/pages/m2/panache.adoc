...
. Access the https://console-openshift-console.{openshift_cluster_ingress_domain}/topology/ns/{user}-quarkus[OpenShift console^], select **Software Catalog**, under **Ecosystem** on the left.
+
