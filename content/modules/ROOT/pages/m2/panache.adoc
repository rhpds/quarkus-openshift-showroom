...
. From the web IDEA, access the file _src/main/resources/application.properties_, to see the following configuration which has been already added in advance.
+
[source,properties]
----
...
. Select *Create*, and label the items with proper icons:
+
[source,sh,role="copypaste"]
----
