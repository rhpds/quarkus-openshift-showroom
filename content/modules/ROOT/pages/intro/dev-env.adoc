...
. Navigate to https://devspaces.{openshift_cluster_ingress_domain}#https://github.com/learn-quarkus/ibm-quarkus-beginners-workshop-m1-labs/tree/ibm-3.27[access the Red Hat OpenShift Dev Spaces instance^] and select *Log in with OpenShift* button:
+
